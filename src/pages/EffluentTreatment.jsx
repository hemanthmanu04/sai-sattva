  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        ></div>
        <h1 className="absolute text-[#44832a] top-[42%] left-[10%] lg:top-[40%] lg:left-[25%] font-semibold lg:text-6xl text-4xl text-center">
        ...
        <div>
          <div className="lg:flex lg:my-24">
            ...
            <img
              src="images/etp.jpg"
              alt="STP"
              className="w-[70%] lg:w-[30%] mb-10 lg:mr-10 lg:h-[350px] h-[300px] mx-auto mt-20 rounded-sm"
            />
          </div>
        </div>
      </div>
