    ...
    <div>
      ...
      <div className="opacity-100 transition-opacity duration-500">
          ...
          <div className="lg:flex">
            <div className="lg:pt-20">
              ...
              <p className="mb-4 text-md lg:text-lg text-slate-700 font-medium tracking-wide">
                ...
                responsibilities with utmost dedication, striving to ensure that
                its services consistently exceed customer expectations.
              </p>
            </div>
            <img
              src="images/tu.jpg"
        ...
        <p className="md:mx-12 mx-4 text-md lg:text-lg text-slate-700 font-medium tracking-wide">
          ...
          Management Plans, Rainwater Harvesting, and more. Sai Sattva excels in
          providing turnkey solutions for water and wastewater management,
        ...
        <p className="md:mx-12 mx-4 my-10 text-md lg:text-lg text-slate-700 font-medium tracking-wide">
          ...
          ultimate satisfaction of end customers. The company remains dedicated
          to supporting customers through a committed helpline, timely
          assistance, warranty services, and addressing a spectrum of issues,
          ranging from installation to routine maintenance.
        </p>
            ...
            <div className="lg:flex">
              ...
              <div className="lg:mx-8 lg:mt-16">
                ...
                <p className="my-4 text-slate-700 tracking-wide font-medium">
                  ...
                  meet and exceed client expectations have been the hallmark of
                  his career. Throughout his professional journey, he has built
                  a strong rapport with clients, earning their trust and
                  satisfaction.
                </p>
              </div>
            </div>
