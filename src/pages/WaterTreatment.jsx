  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        ></div>
        <h1 className="absolute text-[#44832a] top-[40%] left-[13%] lg:top-[40%] lg:left-[30%] font-semibold text-3xl lg:text-6xl text-center">
        ...
        <div>
          <div className="lg:flex lg:my-24">
            ...
            <img
              ...
              alt="STP"
              className="w-[85%] lg:w-[30%] lg:mr-10 h-[400px] mx-auto mt-24 mb-12 rounded-sm"
            />
          </div>
        </div>
      </div>
