  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        ></div>
        <h1 className="absolute text-[#44832a] top-[42%] left-[5%] lg:top-[40%] lg:left-[26%] font-semibold text-3xl lg:text-6xl text-center">
        ...
        <div>
          <div className="lg:flex lg:my-24">
            ...
            <img
              ...
              alt="STP"
              className="w-[85%] lg:w-[30%] lg:mr-10 h-[400px] mb-20 lg:h-[500px] mx-auto mt-20 rounded-sm"
            />
          </div>
        </div>
      </div>
